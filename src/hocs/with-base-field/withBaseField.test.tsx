...
const MockComponent: React.FC<{
  ...
  <div>
    <input data-testid="mock-input" onChange={props.onChange} onBlur={props.onBlur} value={props.value} />
  </div>
);
...
describe('withBaseField', () => {
  ...
  it('Should render the enhanced component', () => {
    render(<EnhancedComponent formhandler={mockFormHandler} name="fieldName" />);
